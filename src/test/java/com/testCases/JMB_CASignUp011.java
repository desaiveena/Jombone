...
//Company Login-invalid user name & invalid password ( negative testing)
...
public class JMB_CASignUp011 extends BaseClass {
	
	@Test(priority=1)
	public void JMB_CASignUp011() throws IOException
	{
		...
		loginpg.settxtemail(company_invalid_username);		//Pass username1 declared in config file
		loginpg.settxtpassword(company_invalid_password);	//Pass password declared in config file
