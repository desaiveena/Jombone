...
//company login-user is redirected to the appropriate page after login
...
public class JMB_CASignUp018 extends BaseClass {
	
	@Test(priority=1)
	public void JMB_CASignUp018() throws IOException
	{
