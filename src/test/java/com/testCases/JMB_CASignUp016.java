...
//Company Login - Forgot password Link
...
public class JMB_CASignUp016 extends BaseClass 
{
	
	@Test(priority=1)
	public void JMB_CASignUp016() throws IOException
	{
		...
		emailBox.sendKeys(company_username);
