...
//Candidate click on Sign up link
...
public class JMB_CASignUp007 extends BaseClass 
{
	
	@Test(priority=1)
	public void JMB_CASignUp007() throws IOException
	{
		...
		WebElement CIn = driver.findElement(By.xpath("//*[@id=\"collapsibleNavbar\"]/ul[2]/li[2]/div/div/div/a[1]"));
		CIn.click();
