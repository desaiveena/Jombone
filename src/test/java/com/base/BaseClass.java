...
public class BaseClass 
{
	...
	public String company_username=readconfig.company_getusername();
	public String company_password=readconfig.company_getpassword();
	public String company_invalid_username=readconfig.company_getinvalid_username();
	public String company_invalid_password=readconfig.company_getinvalid_password();
	public String invalid_username1=readconfig.invalid_getUsername();
	public String password=readconfig.getPassword(); 
	public String invalid_password=readconfig.invalid_getPassword();
	...
	{	
		if(browser.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver",
					"/Users/veenadesai/eclipse-workspace/eBanking/Driver/chromedriver");
